...
function TimelineList({ items, icon: Icon }: TimelineListProps) {
  return (
    <div className="relative">
      {/* Center line */}
      <div className="absolute left-4 top-0 h-full w-px -translate-x-1/2 bg-gray-200 md:left-1/2" />
    ...
    <section id="experience" className="py-20 md:py-28">
      <div className="container-narrow">
        ...
        <div className="mx-auto mt-12 max-w-3xl">
          ...
          <h3 className="mb-6 mt-16 flex items-center gap-2 text-xl font-semibold text-gray-900">
